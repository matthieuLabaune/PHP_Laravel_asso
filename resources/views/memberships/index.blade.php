                ...
                <div class="m-2">
                    <div class="col-md-3 mt-3 mb-3">
                        <a class="btn bg-green-300 hover:bg-green-200 text-gray-800 font-semibold py-2 px-4 rounded shadow"
                           ...
                           role="button">Nouvelle adhésion</a>
                    </div>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        @foreach($memberships as $membership)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-no-wrap">
                                                    {{$membership->price}} · {{$membership->payment_type}}
                                                </td>

                                                <td class="px-6 py-4 whitespace-no-wrap">
                                                    {{$membership->licence->duration}} {{$membership->license->unity}}
                                                </td>

                                                <td class="px-6 py-4 whitespace-no-wrap">
                                                    @foreach($license->memberships as $membership)
                                                        {{--{{dd($membership->user->id)}}--}}
                                                        <a href="{{route('users.show', $membership->user->id)}}"> {{ $membership->user->name }} </a>
                                                        ;
                                                    @endforeach
                                                </td>
